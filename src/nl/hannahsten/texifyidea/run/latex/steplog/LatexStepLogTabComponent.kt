...
internal class LatexStepLogTabComponent(
    ...
    private val runNodeData = RunNodeData(
        title = mainFile?.nameWithoutExtension ?: TexifyBundle.message("run.step.log.root.title"),
    ...
    override fun getTabTitle(): String = TexifyBundle.message("run.step.log.tab.title")
    ...
    private inner class ShowBibtexMessagesAction :
        ToggleAction(
            TexifyBundle.message("run.step.log.action.show.bibtex"),
            TexifyBundle.message("run.step.log.action.show.bibtex.description"),
            TexifyIcons.DOT_BIB,
        ),
        DumbAware {
    ...
    private inner class ShowOverfullUnderfullMessagesAction :
        ToggleAction(
            TexifyBundle.message("run.step.log.action.show.overfull.underfull"),
            TexifyBundle.message("run.step.log.action.show.overfull.underfull.description"),
    ...
    private inner class ExpandAllAction : AnAction(TexifyBundle.message("run.logtab.expand.all"), "", AllIcons.Actions.Expandall), DumbAware {
    ...
    private inner class CollapseAllAction : AnAction(TexifyBundle.message("run.logtab.collapse.all"), "", AllIcons.Actions.Collapseall), DumbAware {
    ...
    private fun NodeStatus.presentableText(): String = when (this) {
        NodeStatus.UNKNOWN -> TexifyBundle.message("run.step.log.status.pending")
        NodeStatus.RUNNING -> TexifyBundle.message("run.step.log.status.running")
        NodeStatus.SUCCEEDED -> TexifyBundle.message("run.step.log.status.successful")
        NodeStatus.SKIPPED -> TexifyBundle.message("run.step.log.status.skipped")
        NodeStatus.WARNING -> TexifyBundle.message("run.step.log.status.completed.with.warnings")
        NodeStatus.FAILED -> TexifyBundle.message("run.step.log.status.failed")
    }
